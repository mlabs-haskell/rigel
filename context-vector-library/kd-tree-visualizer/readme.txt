This is a visualizer to study how KDTree works.
...
The white point is the closest point to the target. 
This will update in real-time as you move the target around.
